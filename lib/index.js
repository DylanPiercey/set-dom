 ...
 *
 * @param {Object} prev - The previous HTMLNode.
 * @param {Object} next - The updated HTMLNode.
 */
function setNode (prev, next) {
  ...
  if (next.nodeName === '#text') {
    if (prev.nodeName === '#text') {
      ...
      // Otherwise we have to replace the node.
 ...
 *
 * @param {Object} parent - The current parentNode being updated.
 ...
 *
 * @param {Object} parent - The current parentNode being updated.
 * @param {Object} prevChildNodes - The previous children.
 * @param {Object} nextChildNodes - The updated children.
 */
function setChildNodes (parent, prevChildNodes, nextChildNodes) {
  ...
  for (key in next) {
    ...
    if (a) {
      ...
      setNode(a, b)
      // Check if we should reposition the node.
 ...
 *
 * @param {Object} childNodes - The childNodes to convert.
 * @return {Object}
 */
 ...
 * @param {*} alt - A fallback key for the node.
 * @return {String|undefined}
 */
function getKey (node, alt) {
  if (typeof node.getAttribute !== 'function') return alt
  return node.id || node.getAttribute('data-key') || alt
}
